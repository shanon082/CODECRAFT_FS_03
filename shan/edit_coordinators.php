...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['update'])) {
    ...
    $new_name = $conn->real_escape_string($_POST['coordinator_name']);
    $new_contact = $conn->real_escape_string($_POST['coordinator_contact']);
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['delete'])) {
    ...
    $new_email = $conn->real_escape_string($_POST['email']);
    $new_pass = $conn->real_escape_string($_POST['password']);
    $sql = "DELETE FROM  coordinators WHERE id='$new_id'";
...
<head>
    ...
    <title>change coordinator</title>
</head>
<body>
    <div class="container">
        <h2>Make changes</h2>
        ...
        <label for="id">id:</label>
            ...
            <button type="button" name = "button" onclick="window.location.href='Admin_Coordinator_dashboard.php'">Back</button>
