...
if ($_SERVER["REQUEST_METHOD"] == "POST" && (isset($_POST['update']) || isset($_POST['delete']))) {
    ...
    if ($action === 'update') {
        ...
        $stmt = $conn->prepare("UPDATE students SET username = ?, student_number = ?, student_contact = ?, email = ?, password = ? WHERE id = ?");
...
<body>
    ...
    <div class="main-content">
        <div class="content-header">
            <h2>Students</h2>
            <button class="add-btn" onclick="openModal('add')">Add Student</button>
        </div>
    ...
    <div class="modal" id="editStudentModal">
        <div class="modal-content">
            ...
            <form action="manage_students.php" method="POST">
                ...
                <input type="text" name="student_contact" id="edit_student_contact" placeholder="Student Contact" required>
                <input type="email" name="email" id="edit_email" placeholder="Student Email" required>
    ...
    <script>
        function openModal(type, data = null) {
            if (type === 'add') {
                ...
                document.getElementById('edit_student_number').value = data.number;
                document.getElementById('edit_student_contact').value = data.contact;
